    ...
    <div className="optimization-summary">
      ...
      <div className="summary-card" data-aos="fade-up" data-aos-delay="100">
        ...
        <div className="summary-content">
          ...
          <p className="summary-value">{(optimization.totalDistance || 0).toFixed(2)} km</p>
        </div>
      </div>
    </div>
          ...
          <div className="routes-tab">
            {optimization.routes && optimization.routes.map((route, index) => (
              <div key={index} className="route-card">
                ...
                <p>
                  <strong>Total Distance:</strong> {(route.distance || 0).toFixed(2)} km
                </p>
                <p>
              ...
              <table className="details-table">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{(optimization.totalDistance || 0).toFixed(2)} km</td>
                  </tr>
                  <tr>
                    <td>Total Stops</td>
                    <td>
